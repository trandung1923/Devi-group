                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            ...
                            <h3 className='text-kellygreen text-sm font-semibold text-center lg:text-start'>Get 10% off on first enroll</h3>
                        </div>
                        <h1 className='text-midnightblue text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-120 pt-5 lg:pt-0'>Start learning German with Devi-Group</h1>
                        <h3 className='text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0'>Chúng tôi là một công ty tư vấn nhân sự quốc tế có trụ sở tại Đức với đối tác trên toàn cầu.Nỗ lực tận tâm của chúng tôi nhằm hỗ trợ những người có nguyện vọng phát triển tại Đức và tạo ra kết nối giữa họ với các tổ chứcĐức. Trọng tâm chính của chúng tôi xoay quanh các chương trình đào tạo nghề và các công việc nghề nghiệp.</h3>
                        ...
                        <div className='flex items-center justify-between pt-10 lg:pt-4'>
                            ...
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Tư vấn du học Đức</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Dịch vụ làm hồ sơ du học Đức</p>
                            </div>
                        </div>
                    </div>
